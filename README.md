...
* **Partes do processo:** vêm das publicações do DJEN (destinatários por polo e advogados com OAB) e aparecem na lista, no detalhe e na busca. Enquanto o processo não tiver publicação, o analista pode incluir as partes a partir da consulta processual do tribunal, informando a URL como evidência. O botão **Buscar partes no DJEN** (Fontes e saúde) consulta de imediato os processos pendentes; a coleta agendada faz o mesmo a cada ciclo. Cada processo sem publicação volta à fila só depois de 24 horas. Nenhum documento de pessoa física é guardado.
